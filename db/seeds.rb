...
", word_count: 77334, status: "Available", author_id: 2, number: 1)
...
", word_count: 28404, status: "Not Available", author_id: 3, number: 1)

book6 = Book.create!(title:"Polgara the Sorceress", description: "Story about Polgara" , word_count: 456789, status: "Available", author_id: 5, number: 1)

book4 = Book.create!(title:"Belgarath the Sorcerer", description: "Story about Belgarath" , word_count: 87234, status: "Available", author_id: 5, number: 1)

book5 = Book.create!(title:"The Elder Gods", description: "Story about Elder Gods" , word_count: 9872, status: "Available", author_id: 5, number: 1)

book6 = Book.create!(title:"Weasel", description: "Alone in the frontier wilderness in the winter of 1839, 11-year-old Nathan runs afoul of the renegade killer known as Weasel and makes a surprising discovery about the concept of revenge. The plot contains racial slurs and violence." , word_count: 23960, status: "Available", author_id: 1, number: 2)
book7 = Book.create!(title:"Weasel", description: "Alone in the frontier wilderness in the winter of 1839, 11-year-old Nathan runs afoul of the renegade killer known as Weasel and makes a surprising discovery about the concept of revenge. The plot contains racial slurs and violence." , word_count: 23960, status: "Available", author_id: 1, number: 3)
book8 = Book.create!(title: "Night", description: "This book chronicles the true and terrifying story of the author and his life as a Jew under the Nazis.
", word_count: 28404, status: "Not Available", author_id: 3, number: 2)
